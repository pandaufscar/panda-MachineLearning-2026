# 🧠 Grupo de Estudo de Machine Learning - Panda UFSCar 2026

## 👥 Sobre o Grupo

O Grupo de Estudo de Machine Learning faz parte dos **Grupos de Estudo 2026** do **Panda UFSCar** (Grupo de Processamento e Análise de Dados).

Nosso objetivo é proporcionar um ambiente colaborativo para aprendizado prático de Machine Learning, partindo do zero e construindo conhecimento de forma gradual e acessível.

Ao longo de **17 semanas**, os participantes terão contato com conceitos fundamentais, bibliotecas essenciais (Python, Pandas, Scikit-learn) e desenvolverão projetos práticos que consolidarão o aprendizado. Todo o material produzido será disponibilizado publicamente neste repositório, contribuindo para a comunidade acadêmica.

---

## 👥 Membros do Grupo

| Nome | Curso | Nível de Conhecimento |
|------|-------|----------------------|
...
**Legenda dos níveis:**
- **Nenhum:** Nunca teve contato com Machine Learning
- **Básico:** Teve contato em disciplinas
- **Intermediário:** Já realizou projetos práticos

**Abordagem adotada:** Todo o conteúdo é nivelado para iniciantes. A mentora com nível intermediário atua como monitora voluntária, oferecendo suporte durante os encontros. As atividades são realizadas em duplas para promover integração e colaboração entre todos.

---

## 🎯 Objetivos do Grupo

- ✅ Aprender Machine Learning de forma colaborativa e acessível para iniciantes
- ✅ Desenvolver habilidades práticas com Python, Pandas e Scikit-learn
- ✅ Criar um repositório público com materiais de estudo organizados
- ✅ Apresentar os resultados no Workshop Panda 2026
